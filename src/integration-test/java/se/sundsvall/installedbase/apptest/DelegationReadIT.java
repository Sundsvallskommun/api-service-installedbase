...
class DelegationReadIT extends AbstractAppTest {
	...
	@Test
	void test02_getDelegationsByOwnerAndDelegatedTo() {
		final var owner = "81471222-5798-11e9-ae24-57fa13b361e1";
		final var delegatedTo = "f2949c12-bb83-406a-be96-bb8628f14612";
		setupCall()
	...
	@Test
	void test03_getDelegationsByOwner() {
		final var owner = "81471222-5798-11e9-ae24-57fa13b361e1";
		setupCall()
	...
	@Test
	void test04_getDelegationsByDelegatedTo() {
		final var delegatedTo = "81471222-5798-11e9-ae24-57fa13b361e2";
		setupCall()
	...
	@Test
	void test05_getDelegationsByDelegatedToAndAnotherMunicipalityId() {
		final var delegatedTo = "81471222-5798-11e9-ae24-57fa13b361e2";
		setupCall()
			.withServicePath("/1984/delegations?delegatedTo=" + delegatedTo)
			.withHttpMethod(GET)
			.withHeader(X_SENT_BY, X_SENT_BY_VALUE)
			.withExpectedResponseStatus(OK)
			.withExpectedResponse(RESPONSE_FILE)
	...
	@Test
	void test06_getDelegationByIdAndMunicipalityId() {
		final var delegationId = "78ee675d-4ab5-4c9c-a80a-5c508f1c55af";
		setupCall()
			.withServicePath("/1984/delegations" + "/" + delegationId)
			.withHttpMethod(GET)
			.withHeader(X_SENT_BY, X_SENT_BY_VALUE)
			.withExpectedResponseStatus(OK)
			.withExpectedResponse(RESPONSE_FILE)
